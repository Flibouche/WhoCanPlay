...
class GameRepository extends ServiceEntityRepository
{
    ...
    public function findProcessedFeaturesByGame($gameId)
    {
        ...
        /*
            SELECT f0_.id AS id_0, f0_.state AS state_1, f0_.name AS name_2, f0_.content AS content_3, d1_.name AS name_4, d1_.icon AS icon_5, i2_.url AS url_6, i2_.alt_text AS alt_text_7, i2_.title AS title_8, i2_.submission_date AS submission_date_10 
